...
HD_PWD='C:/Users/yazmr/OneDrive/Masast/Vivado Codes/compressor_imprecise/compressor_imprecise.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log compressor_4to2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source compressor_4to2.tcl
